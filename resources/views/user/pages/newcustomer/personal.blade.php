                ...
                <form action="{{ URL::to('new-member/personal') }}" method="POST" id="personalForm"
                    ...
                    <div id="smartwizard">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('identity_personal_number') }}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('personal_address') is-invalid @enderror" id="personal_address"
                                                name="personal_address" rows="8" placeholder="Masukkan Alamat Lengkap Anda...">{{ old('personal_address') }}</textarea>
                            ...
                            <iframe src="https://docs.google.com/document/d/e/2PACX-1vTj32yhGrASZFiwRmOEs4ZudnKnSn3vUxST3rgx96ox7LVCS-7wR-DXmoAC9TuQBZU00TcBTgP5WFz6/pub?embedded=true" style="width: 100%; height: 500px;"></iframe>
