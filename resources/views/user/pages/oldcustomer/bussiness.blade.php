                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('identity_number', $oldCustData->identity_number) }}"
                                                readonly>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('personal_address') is-invalid @enderror" id="personal_address"
                                                name="personal_address" rows="3" placeholder="Masukkan Alamat Lengkap Anda..." readonly>{{ old('personal_address', $oldCustData->address) }}</textarea>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('company_name', $oldCustData->company_name) }}" readonly>
                                            @error('company_name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('company_address', $oldCustData->company_address) }}"
                                                readonly>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('company_npwp', $oldCustData->company_npwp) }}" readonly>
                                            @error('company_npwp')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('company_employees', $oldCustData->company_employees) }}"
                                                readonly>
                            ...
                            <div id="technical-info" class="tab-pane" role="tabpanel" aria-labelledby="technical-info">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('technical_service') is-invalid @enderror"
                                        name="technical_service" id="technical_service">
