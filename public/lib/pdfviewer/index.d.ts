...
declare const allowedToolbarTypes: ("note" | "comment" | "text" | "arrow" | "highlighter" | "undo" | "redo" | "search" | "ellipse" | "image" | "line" | "polygon" | "polyline" | "signature" | "print" | "rectangle" | "ink" | "stamp" | "cloudy-rectangle" | "dashed-rectangle" | "cloudy-ellipse" | "dashed-ellipse" | "cloudy-polygon" | "dashed-polygon" | "text-highlighter" | "sidebar-thumbnails" | "sidebar-document-outline" | "sidebar-annotations" | "sidebar-bookmarks" | "pager" | "pan" | "zoom-out" | "zoom-in" | "zoom-mode" | "spacer" | "annotate" | "ink-eraser" | "document-editor" | "document-crop" | "export-pdf" | "debug" | "layout-config" | "marquee-zoom" | "custom" | "responsive-group" | "redact-text-highlighter" | "redact-rectangle" | "document-comparison" | "form-creator")[];
